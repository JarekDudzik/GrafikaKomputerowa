...
class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void PyramidBaseOnCircle(GL2 gl2,int numVertices){
		...
		for (int i = 1; i <= numVertices; i++)  // pętla powielająca wielokąty
		{
			...
			gl2.glMaterialfv (GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[1],2); // nadanie trójkątom materiału w kolorze brązu
	...
	public void init(GLAutoDrawable drawable) {
		...
		gl2.glLightModelfv(GL2.GL_LIGHT_MODEL_AMBIENT, GL_AMBIENT_AND_DIFFUSE,1 ); // funkcja do ustawienia kolor´ow materialu otoczenia, rozproszonego, lustrzanego i emisyjnego, określamy kolejno stronę, rodzaj
